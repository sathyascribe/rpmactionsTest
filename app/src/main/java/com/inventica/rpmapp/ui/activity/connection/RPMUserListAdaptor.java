...
public class RPMUserListAdaptor extends RecyclerView.Adapter<RPMUserListAdaptor.ViewHolder> {
    ...
    public RPMUserListAdaptor(Context context, ArrayList<ListUserModel> data) {
...
//
         holder.constraintLayout.setOnClickListener(v -> mInflater.getContext().startActivity(new Intent(mInflater.getContext(),
                 UserDetailsForInvitationConnection.class).putExtra("Object", parcelableModel)));
