 ...
 */
public class MyAdapterFavourite extends RecyclerView.Adapter<MyAdapterFavourite.ViewHolder> implements FastScrollRecyclerViewInterface {
    ...
    public MyAdapterFavourite(ArrayList<String> myDataset, HashMap<String, Integer> mapIndex, ArrayList<GetAllSongs> song_datalist) {
        mDataset = myDataset;
        mMapIndex = mapIndex;
