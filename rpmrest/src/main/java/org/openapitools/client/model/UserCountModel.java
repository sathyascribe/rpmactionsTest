...
public class UserCountModel implements Serializable {
  ...
  public static final String SERIALIZED_NAME_TOTAL_GROUP_ADMIN_SUBSCRIPTION_USERS_COUNT = "totalGroupAdminSubscriptionUsersCount";
  @SerializedName(SERIALIZED_NAME_TOTAL_GROUP_ADMIN_SUBSCRIPTION_USERS_COUNT)
  private Integer totalGroupAdminSubscriptionUsersCount;

  public static final String SERIALIZED_NAME_TOTAL_SUBSCRIPTION_USERS_COUNT = "totalSubscriptionUsersCount";
  @SerializedName(SERIALIZED_NAME_TOTAL_SUBSCRIPTION_USERS_COUNT)
  private Integer totalSubscriptionUsersCount;
  ...
  **/
  ...
  public UserCountModel totalGroupAdminSubscriptionUsersCount(Integer totalGroupAdminSubscriptionUsersCount) {
    
    this.totalGroupAdminSubscriptionUsersCount = totalGroupAdminSubscriptionUsersCount;
    return this;
  }

   /**
   * Get totalGroupAdminSubscriptionUsersCount
   * @return totalGroupAdminSubscriptionUsersCount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getTotalGroupAdminSubscriptionUsersCount() {
    return totalGroupAdminSubscriptionUsersCount;
  }


  public void setTotalGroupAdminSubscriptionUsersCount(Integer totalGroupAdminSubscriptionUsersCount) {
    this.totalGroupAdminSubscriptionUsersCount = totalGroupAdminSubscriptionUsersCount;
  }


  public UserCountModel totalSubscriptionUsersCount(Integer totalSubscriptionUsersCount) {
    
    this.totalSubscriptionUsersCount = totalSubscriptionUsersCount;
    return this;
  }

   /**
   * Get totalSubscriptionUsersCount
   * @return totalSubscriptionUsersCount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Integer getTotalSubscriptionUsersCount() {
    return totalSubscriptionUsersCount;
  }


  public void setTotalSubscriptionUsersCount(Integer totalSubscriptionUsersCount) {
    this.totalSubscriptionUsersCount = totalSubscriptionUsersCount;
  }


  public UserCountModel activeUsers(Integer activeUsers) {
  ...
  **/
  ...
  public UserCountModel unActiveUsers(Integer unActiveUsers) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalUsers, userCountModel.totalUsers) &&
        ...
        Objects.equals(this.totalGroupAdminSubscriptionUsersCount, userCountModel.totalGroupAdminSubscriptionUsersCount) &&
        Objects.equals(this.totalSubscriptionUsersCount, userCountModel.totalSubscriptionUsersCount) &&
        Objects.equals(this.activeUsers, userCountModel.activeUsers) &&
        Objects.equals(this.unActiveUsers, userCountModel.unActiveUsers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalUsers, maleUsers, femaleUsers, ageUsersBetween18to40, ageUsersBetween40to70, ageUsersBetween70to100, totalGroupAdminSubscriptionUsersCount, totalSubscriptionUsersCount, activeUsers, unActiveUsers);
  }
  ...
  public String toString() {
    ...
    sb.append("    totalGroupAdminSubscriptionUsersCount: ").append(toIndentedString(totalGroupAdminSubscriptionUsersCount)).append("\n");
    sb.append("    totalSubscriptionUsersCount: ").append(toIndentedString(totalSubscriptionUsersCount)).append("\n");
