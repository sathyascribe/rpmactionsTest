...
public class GetVideoCateoryModel implements Serializable {
  ...
  public GetVideoCateoryModel id(Long id) {
  ...
  **/
  ...
  public GetVideoCateoryModel videoType(String videoType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetVideoCateoryModel getVideoCateoryModel = (GetVideoCateoryModel) o;
    return Objects.equals(this.id, getVideoCateoryModel.id) &&
        Objects.equals(this.videoType, getVideoCateoryModel.videoType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, videoType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetVideoCateoryModel {\n");
